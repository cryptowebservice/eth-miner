export const ETH_MINER_ADDRESS = "0x6C5664fBcd44E19653F6DfDE699027eA4c23b955";
export const ETH_MINER_ABI = [
  ...
  {
    inputs: [
      { internalType: "address", name: "adr1", type: "address" },
      { internalType: "address", name: "adr2", type: "address" },
    ],
    name: "seedMarket",
    outputs: [],
    stateMutability: "payable",
